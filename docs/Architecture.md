...
Dev-only integration ("seam") runtime scaffolding: `find_guest`, ephemeral manifests, single-guest assembly, and the in-process HTTP driver. See [the testing guide](guides/testing.md) for usage and policy.
