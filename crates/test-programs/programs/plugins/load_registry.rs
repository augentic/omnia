...
//! identity, then prove idempotency by re-loading pinned with the resolved
//! digest. The loader import arrives through the SDK's own bindings; this
//! world only imports `ops`.
