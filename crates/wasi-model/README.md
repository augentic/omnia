...
This crate provides the `omnia:model/completion` boundary for the Omnia runtime: the domain-agnostic *seam* a guest calls to have a prompt completed (`complete: func(prompt) -> result<answer, error>`).
