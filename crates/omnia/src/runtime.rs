//! # Pooling allocator observability
//!
//! Background sampling of the Wasmtime pooling allocator's occupancy, emitted
//! as `OpenTelemetry` gauges via the `tracing` metrics bridge so pool sizing
//! can be tuned from real data rather than guesswork.
