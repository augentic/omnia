...
mod tests {
    ...
    fn parse_and_resolve_mounts() {
        ...
        assert_eq!(resolved[0].perms, wasmtime_wasi::FsPerms::ReadOnly);
        ...
        assert_eq!(resolved[1].perms, wasmtime_wasi::FsPerms::ReadWrite);
    }
    ...
    fn cli_mount_resolves_relative_to_base() {
        ...
        assert_eq!(resolved.perms, wasmtime_wasi::FsPerms::ReadWrite);
    }
